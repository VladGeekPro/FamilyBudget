...
return [
    ...
    'buttons' => [
        ...
        'copy' => 'Копировать',
        'voice_expense' => 'Голосовой ввод',
        'voice_notes' => 'Голосовая заметка',
    ...
    'voice' => [
        'helper' => 'Нажмите на микрофон, продиктуйте запись, затем при необходимости перезапишите или сохраните её для обработки.',
        'transcript' => 'Результат обработки',
        'status' => [
            'idle' => 'Нажмите на микрофон, чтобы начать запись',
            'recording' => 'Идёт запись',
            'ready' => 'Запись готова к сохранению',
            'processing' => 'Обработка записи...',
        ],
        'actions' => [
            'cancel' => 'Отмена записи',
            'retry' => 'Записать заново',
            'save' => 'Сохранить запись',
        ],
        'expense' => [
            'modal_heading' => 'Голосовой ввод затраты',
            'modal_description' => 'Запишите затраты голосом. После обработки форма будет заполнена автоматически, насколько это возможно.',
        ],
        'notes' => [
            'tooltip' => 'Продиктовать заметку',
            'modal_heading' => 'Голосовой ввод заметки',
            'modal_description' => 'Продиктуйте заметку, а система преобразует её в аккуратный текст на русском языке.',
        ],
        'notifications' => [
            'applied' => 'Голосовая запись успешно обработана.',
            'applied_title' => 'Запись применена',
            'applied_body' => [
                'expense' => 'Поля затраты обновлены по результатам распознавания.',
                'notes' => 'Заметка обновлена по результатам распознавания.',
            ],
            'failed_title' => 'Не удалось обработать запись',
            'unsupported_title' => 'Запись недоступна',
            'unsupported_body' => 'Браузер не поддерживает запись аудио через MediaRecorder.',
            'unexpected_error' => 'Во время обработки голосовой записи произошла непредвиденная ошибка.',
            'fastapi_url_missing' => 'Не указан URL FastAPI-сервиса для обработки голосового ввода.',
            'fastapi_failed' => 'FastAPI-сервис завершился с ошибкой.',
            'fastapi_unreachable' => 'Не удалось подключиться к сервису распознавания. Попробуйте ещё раз через несколько секунд.',
            'fastapi_backend_unavailable' => 'Сервис распознавания речи временно недоступен. Попробуйте позже.',
            'invalid_payload' => 'Не удалось подготовить данные для voice-сервиса.',
            'invalid_response' => 'Voice-сервис вернул некорректный JSON.',
            'empty_result' => 'Не удалось извлечь ни одного значения из голосовой записи.',
        ],
    ],
];
