...
return [
    ...
    */
    ...
    'after' => 'Дата должна быть позже текущего месяца.',
    'after_or_equal' => 'Дата должна быть не ранее текущего месяца.',
    ...
    'boolean' => 'Поле :attribute должно быть логическим значением — true или false.',
    ...
    'present_if' => 'Поле :attribute должно быть заполнено, если :other равно :value.',
    'present_unless' => 'Поле :attribute должно быть заполнено, если только :other не равно :value.',
    'present_with' => 'Поле :attribute должно быть заполнено, если указано :values.',
    'present_with_all' => 'Поле :attribute должно быть заполнено, если указаны все значения :values.',
