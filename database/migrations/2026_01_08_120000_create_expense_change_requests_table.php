...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('expense_change_requests', function (Blueprint $table) {
            ...
            $table->foreignId('current_supplier_id')->nullable()->constrained('suppliers')->nullOnDelete();
            $table->decimal('current_sum', 12, 2)->nullable();
            $table->text('current_notes')->nullable();

            $table->date('requested_date')->nullable();
            $table->foreignId('requested_user_id')->nullable()->constrained('users')->nullOnDelete();
            $table->foreignId('requested_category_id')->nullable()->constrained('categories')->nullOnDelete();
