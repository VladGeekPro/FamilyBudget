                                    ...
                                    <summary class="list-none cursor-pointer select-none">
                                        <div class="flex items-center justify-between gap-3">
                                            <div class="flex items-center gap-2 sm:gap-3 min-w-0">
                                                ...
                                                <p class="text-xs sm:text-sm font-semibold text-emerald-900 dark:text-emerald-100 truncate">
                                                    История оплат по долгу ({{ $paidDebts->count() }})
                                                </p>
                                            </div>
                                            <svg class="w-4 h-4 text-emerald-700 dark:text-emerald-300 transition-transform duration-200 group-open:rotate-180 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-4 gap-2 sm:gap-3 text-xs sm:text-sm">
                                                ...
                                                <div class="flex flex-col">
                                                    ...
                                                    <div class="flex items-center gap-2 mt-0.5 min-w-0">
                                                        <div class="w-6 h-6 rounded-full bg-slate-400/70 dark:bg-slate-600/70 overflow-hidden flex items-center justify-center flex-shrink-0">
                                                            @if($userImage)
                                                        ...
                                                        <p class="font-medium text-slate-900 dark:text-slate-100 text-sm truncate">{{ $userName }}</p>
                                                    </div>
                                                </div>
                                                <div class="flex flex-col">
